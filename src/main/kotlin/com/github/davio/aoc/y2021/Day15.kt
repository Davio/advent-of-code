...
//
//    fun getResultPart1() {
//        val route = aStar(chitons, start, Point.of(chitons[0].lastIndex, chitons.lastIndex))
...
//                val ansiColor = if (route.any { it == Point.of(x, y) }) boldRedColor else ansiReset
...
//        }.toTypedArray()
//
//        val route = aStar(expandedMap, start, Point.of(expandedMap[0].lastIndex, expandedMap.lastIndex))
